...
import Rabbit.actions.TimedVFXAction;
import Rabbit.cardmods.CarrotMod;
import Rabbit.patches.CardCounterPatches;
import Rabbit.powers.LosePowerPower;
import Rabbit.powers.NextTurnPowerPower;
...
public class Wiz {
    ...
    public static boolean isInRabbitRun() {
        return CardCrawlGame.isInARun() && AbstractDungeon.player instanceof TheRabbit;
    }
