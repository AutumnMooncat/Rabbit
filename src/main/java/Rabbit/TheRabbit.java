...
import Rabbit.cards.Braveheart;
import Rabbit.cards.CrossBlades;
import Rabbit.cards.Defend;
import Rabbit.cards.Strike;
import Rabbit.cards.interfaces.SkillAnimationAttack;
import Rabbit.relics.Glasses;
...
import static Rabbit.MainModfile.*;

public class TheRabbit extends CustomPlayer {
    ...
    static final String ID = makeID(TheRabbit.class.getSimpleName());
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheRabbit(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Strike.ID);
        retVal.add(Strike.ID);
        retVal.add(CrossBlades.ID);
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Braveheart.ID);
        return retVal;
    }

    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(Glasses.ID);
        return retVal;
    }
    ...
    public AbstractCard.CardColor getCardColor() {
        return Enums.CARROT_ORANGE_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return MainModfile.CARROT_ORANGE_COLOR.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheRabbit(name, chosenClass);
    }
    ...
    public Texture getCutsceneBg() {
        return ImageMaster.loadImage("RabbitResources/images/panels/bkg.png");
    }

    @Override
    public List<CutscenePanel> getCutscenePanels() {
        List<CutscenePanel> panels = new ArrayList<>();
        panels.add(new CutscenePanel("RabbitResources/images/panels/HeartPanel.png", "UNLOCK_PING"));
        return panels;
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_RABBIT;
        @SpireEnum(name = "CARROT_ORANGE_COLOR")
        public static AbstractCard.CardColor CARROT_ORANGE_COLOR;
        @SpireEnum(name = "CARROT_ORANGE_COLOR")
