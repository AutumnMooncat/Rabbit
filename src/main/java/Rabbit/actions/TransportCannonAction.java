...
import Rabbit.vfx.VFXContainer;
...
public class TransportCannonAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        for (AbstractCard c : Wiz.adp().hand.group) {
            addToTop(new VFXAction(VFXContainer.throwEffect(TextureSniper.snipeCard(c), 0.25f, target.hb, MainModfile.CARROT_ORANGE_COLOR, true, false)));
        }
