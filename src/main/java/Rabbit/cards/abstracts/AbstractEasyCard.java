package Rabbit.cards.abstracts;

import Rabbit.MainModfile;
import Rabbit.TheRabbit;
import Rabbit.util.CardArtRoller;
...
import static Rabbit.MainModfile.makeImagePath;
import static Rabbit.MainModfile.modID;
import static Rabbit.util.Wiz.atb;
import static Rabbit.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheRabbit.Enums.CARROT_ORANGE_COLOR);
    }
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        FlavorText.AbstractCardFlavorFields.boxColor.set(this, mix(BLACK.cpy(), MainModfile.CARROT_ORANGE_COLOR.cpy()));
