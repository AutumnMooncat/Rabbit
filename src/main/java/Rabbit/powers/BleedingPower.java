...
import Rabbit.patches.AttackEffectPatches;
import Rabbit.powers.interfaces.OnBleedPower;
...
public class BleedingPower extends AbstractPower implements HealthBarRenderPower {
    ...
    public void onAttack(DamageInfo info, int damageAmount, AbstractCreature target) {
        if (target != owner && info.type == DamageInfo.DamageType.NORMAL) {
            addToTop(new DamageAction(owner, new DamageInfo(source, amount, DamageInfo.DamageType.HP_LOSS), AttackEffectPatches.RABBIT_BLEED));
